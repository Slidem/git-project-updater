...
from git_project_updater_business.scanners.converter.maven.maven_versions_link import MavenProjectVersionsProcessorLink
...
class MavenProjectProcessorChainFactory:
    ...
    def create_chain(self, projects):
        ...
        root.add_next(MavenProjectDependencyTreeLink()).add_next(
            MavenProjectVersionsProcessorLink())
